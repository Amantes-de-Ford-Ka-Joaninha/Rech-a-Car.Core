...
import { FuncionarioEditViewModel } from './shared/viewModels/funcionario/FuncionarioEditViewModel';
...
const routes: Routes = [
  ...
  { path: 'funcionario/editar/:id', component: FuncionarioEditViewModel }
];
